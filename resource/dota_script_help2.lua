...
MODIFIER_EVENT_NEUTRAL_ENHANCEMENT_OPTIONS = 366 -- GetModifierNeutralEnhancementOptions
MODIFIER_EVENT_NEUTRAL_TRINKET_OPTIONS = 365 -- GetModifierNeutralTrinketOptions
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 205 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 202 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 203 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 201 -- OnAbilityStart
MODIFIER_EVENT_ON_ABILITY_TOGGLED = 359 -- OnAbilityToggled
MODIFIER_EVENT_ON_ASSIST = 257 -- OnAssist
MODIFIER_EVENT_ON_ATTACK = 194 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 215 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 197 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 271 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 196 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 260 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 195 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 192 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 268 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 193 -- OnAttackStart
MODIFIER_EVENT_ON_ATTEMPT_PROJECTILE_DODGE = 278 -- OnAttemptProjectileDodge
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 204 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 229 -- OnBuildingKilled
MODIFIER_EVENT_ON_CLEAVE_ATTACK_LANDED = 348 -- OnCleaveAttackLanded
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 213 -- OnDamageCalculated
MODIFIER_EVENT_ON_DAMAGE_HPLOSS = 307 -- OnDamageHPLoss
MODIFIER_EVENT_ON_DAY_STARTED = 335 -- OnDayStarted
MODIFIER_EVENT_ON_DEATH = 216 -- OnDeath
MODIFIER_EVENT_ON_DEATH_COMPLETED = 217 -- OnDeathCompleted
MODIFIER_EVENT_ON_DEATH_PREVENTED = 209 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 255 -- OnDominated
MODIFIER_EVENT_ON_FORCE_PROC_MAGIC_STICK = 306 -- OnForceProcMagicStick
MODIFIER_EVENT_ON_FOW_TEAM_CHANGED = 357 -- OnFoWTeamChanged
MODIFIER_EVENT_ON_HEALTH_GAINED = 224 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 228 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_BEGIN_DYING = 329 -- OnHeroBeginDying
MODIFIER_EVENT_ON_HERO_KILLED = 227 -- OnHeroKilled
MODIFIER_EVENT_ON_KILL = 256 -- OnKill
MODIFIER_EVENT_ON_MAGIC_DAMAGE_CALCULATED = 214 -- OnMagicDamageCalculated
MODIFIER_EVENT_ON_MANA_GAINED = 225 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 230 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 231 -- OnModifierAdded
MODIFIER_EVENT_ON_MODIFIER_REMOVED = 232 -- OnModifierRemoved
MODIFIER_EVENT_ON_MUTE_DAMAGE_ABILITIES = 318 -- OnMuteDamageAbilities
MODIFIER_EVENT_ON_NIGHT_STARTED = 336 -- OnNightStarted
MODIFIER_EVENT_ON_ORB_EFFECT = 211 -- Unused
MODIFIER_EVENT_ON_ORDER = 199 -- OnOrder
MODIFIER_EVENT_ON_PREDEBUFF_APPLIED = 279 -- OnPreDebuffApplied
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 212 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 206 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 198 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 269 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_PURE_DAMAGE_CALCULATED = 364 -- OnPureDamageCalculated
MODIFIER_EVENT_ON_REFRESH = 207 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 218 -- OnRespawn
MODIFIER_EVENT_ON_RUNE_SPAWN = 361 -- OnRuneSpawn
MODIFIER_EVENT_ON_SET_LOCATION = 223 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 191 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_HEALTH = 220 -- OnSpentHealth
MODIFIER_EVENT_ON_SPENT_MANA = 219 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 210 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 208 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 226 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TAKEDAMAGE_POST_UNAVOIDABLE_BLOCK = 317 -- OnTakeDamagePostUnavoidableBlock
MODIFIER_EVENT_ON_TELEPORTED = 222 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 221 -- OnTeleporting
MODIFIER_EVENT_ON_TIER_TOKEN_REROLLED = 354 -- OnTierTokenRerolled
MODIFIER_EVENT_ON_TREE_CUT_DOWN = 347 -- OnTreeCutDown
MODIFIER_EVENT_ON_UNIT_MOVED = 200 -- OnUnitMoved
MODIFIER_EVENT_SPELL_APPLIED_SUCCESSFULLY = 288 -- OnSpellAppliedSuccessfully
MODIFIER_FUNCTION_INVALID = 65535
MODIFIER_FUNCTION_LAST = 378
MODIFIER_PROPERTY_ABILITY_LAYOUT = 254 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABILITY_POINTS = 320 -- GetModifierAbilityPoints
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 162 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 161 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 163 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 149 -- GetAbsorbSpell
MODIFIER_PROPERTY_ADDITIONAL_NEUTRAL_ITEM_DROPS = 343 -- GetModifierAdditionalNutralItemDrops
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 174 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_AUTOATTACK_WHILE_HOLD_POSITION = 186 -- GetAlwaysAutoAttackWhileHoldPosition
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 175 -- GetAllowEtherealAttack
MODIFIER_PROPERTY_AOE_BONUS_CONSTANT = 315 -- GetModifierAoEBonusConstant
MODIFIER_PROPERTY_AOE_BONUS_CONSTANT_STACKING = 316 -- GetModifierAoEBonusConstantStacking
MODIFIER_PROPERTY_AOE_BONUS_PERCENTAGE = 299 -- GetModifierAoEBonusPercentage
MODIFIER_PROPERTY_ATTACKSPEED_ABSOLUTE_MAX = 327 -- GetModifierAttackSpeedAbsoluteMax
...
MODIFIER_PROPERTY_ATTACKSPEED_PERCENTAGE = 277 -- GetModifierAttackSpeedPercentage
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 274 -- GetModifierAttackSpeedReductionPercentage
MODIFIER_PROPERTY_ATTACK_ANIM_TIME_PERCENTAGE = 130 -- GetModifierPercentageAttackAnimTime
MODIFIER_PROPERTY_ATTACK_HEIGHT_BONUS = 340 -- GetModifierAttackHeightBonus
...
MODIFIER_PROPERTY_AVOID_ATTACK_PROCS = 360 -- GetModifierAvoidAttackProcs
MODIFIER_PROPERTY_AVOID_DAMAGE = 72 -- GetModifierAvoidDamage
MODIFIER_PROPERTY_AVOID_DAMAGE_AFTER_REDUCTIONS = 289 -- GetModifierAvoidDamageAfterReductions
MODIFIER_PROPERTY_AVOID_SPELL = 73 -- GetModifierAvoidSpell
MODIFIER_PROPERTY_BASEATTACK_BONUSDAMAGE = 4 -- GetModifierBaseAttack_BonusDamage
MODIFIER_PROPERTY_BASEATTACK_POSTBONUS = 356 -- GetBaseAttackPostBonus
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE = 61 -- GetModifierBaseDamageOutgoing_Percentage
MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE_UNIQUE = 62 -- GetModifierBaseDamageOutgoing_PercentageUnique
MODIFIER_PROPERTY_BASE_ARMOR_PER_AGI_BONUS_PERCENTAGE = 332 -- GetModifierBonusLotusHeal
...
MODIFIER_PROPERTY_BASE_HP_REGEN_PER_STR_BONUS_PERCENTAGE = 331 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BASE_MANA_REGEN = 89 -- GetModifierBaseRegen
MODIFIER_PROPERTY_BASE_MP_REGEN_PER_INT_BONUS_PERCENTAGE = 333 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BASE_MRES_PER_INT_BONUS_PERCENTAGE = 334 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BECOME_AGILITY = 303 -- GetModifierBecomeAgility
MODIFIER_PROPERTY_BECOME_INTELLIGENCE = 304 -- GetModifierBecomeIntelligence
MODIFIER_PROPERTY_BECOME_STRENGTH = 302 -- GetModifierBecomeStrength
MODIFIER_PROPERTY_BECOME_UNIVERSAL = 305 -- GetModifierBecomeUniversal
MODIFIER_PROPERTY_BONUSDAMAGEOUTGOING_PERCENTAGE = 42 -- GetModifierBonusDamageOutgoing_Percentage
MODIFIER_PROPERTY_BONUS_DAY_VISION = 152 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_DAY_VISION_PERCENTAGE = 153 -- GetBonusDayVisionPercentage
MODIFIER_PROPERTY_BONUS_LOTUS_HEAL = 330 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 154 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 155 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_UPHILL_MISS_CHANCE = 325 -- GetModifierBonusUphillMissChance
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 156 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 273 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 178 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 179 -- Unused
MODIFIER_PROPERTY_BUYBACK_PENALTY_PERCENT = 321 -- GetModifierBuybackPenaltyPercent
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 262 -- GetModifierCanAttackTrees
...
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 251 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_CONSUMABLE_USE_SPEED = 376 -- GetModifierPropertyConsumableUseSpeed
MODIFIER_PROPERTY_CONVERT_ATTACK_PHYSICAL_TO_PURE = 190 -- GetConvertAttackPhysicalToPure
MODIFIER_PROPERTY_CONVERT_MANA_COST_TO_HEALTH_COST = 247 -- GetModifierConvertManaCostToHealthCost
...
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_STACKING = 280 -- GetModifierPercentageCooldownStacking
MODIFIER_PROPERTY_COOLDOWN_REDUCTION_CONSTANT = 35 -- GetModifierCooldownReduction_Constant
MODIFIER_PROPERTY_CREATE_BONUS_ILLUSION_CHANCE = 337 -- GetModifierCreateBonusIllusionChance
MODIFIER_PROPERTY_CREATE_BONUS_ILLUSION_COUNT = 338 -- GetModifierCreateBonusIllusionCount
MODIFIER_PROPERTY_CREEP_DENY_PERCENT = 326 -- GetModifierCreepDenyPercent
MODIFIER_PROPERTY_CRITICAL_STRIKE_BONUS = 189 -- GetCriticalStrikeBonus
...
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE_MULTIPLICATIVE = 294 -- GetModifierDamageOutgoing_PercentageMultiplicative
MODIFIER_PROPERTY_DEATHGOLDCOST = 135 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 151 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 172 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_MANA_GAIN = 173 -- GetDisableManaGain
MODIFIER_PROPERTY_DISABLE_TURNING = 249 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DISASSEMBLE_ANYTHING = 323 -- GetModifierDisassembleAnything
MODIFIER_PROPERTY_DODGE_PROJECTILE = 181 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 266 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 67 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 137 -- GetModifierPercentageExpRateBoost
MODIFIER_PROPERTY_EXTRA_HEALTH_BONUS = 99 -- GetModifierExtraHealthBonus
MODIFIER_PROPERTY_EXTRA_HEALTH_PERCENTAGE = 102 -- GetModifierExtraHealthPercentage
MODIFIER_PROPERTY_EXTRA_MANA_BONUS = 100 -- GetModifierExtraManaBonus
MODIFIER_PROPERTY_EXTRA_MANA_BONUS_PERCENTAGE = 101 -- GetModifierExtraManaBonusPercentage
MODIFIER_PROPERTY_EXTRA_MANA_PERCENTAGE = 103 -- GetModifierExtraManaPercentage
MODIFIER_PROPERTY_EXTRA_STRENGTH_BONUS = 98 -- GetModifierExtraStrengthBonus
MODIFIER_PROPERTY_FAIL_ATTACK = 290 -- GetModifierPropetyFailAttack
MODIFIER_PROPERTY_FIXED_ATTACK_RATE = 32 -- GetModifierFixedAttackRate
MODIFIER_PROPERTY_FIXED_DAY_VISION = 157 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_MANA_REGEN = 324 -- GetModifierFixedManaRegen
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 158 -- GetFixedNightVision
MODIFIER_PROPERTY_FORBID_ILLUSIONS = 369 -- GetModifierPropertyForbidIllusions
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 248 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_FORCE_MAX_HEALTH = 313 -- GetModifierForceMaxHealth
MODIFIER_PROPERTY_FORCE_MAX_MANA = 314 -- GetModifierForceMaxMana
MODIFIER_PROPERTY_FOW_TEAM = 328 -- GetModifierFoWTeam
MODIFIER_PROPERTY_GOLD_RATE_BOOST = 138 -- GetModifierPercentageGoldRateBoost
MODIFIER_PROPERTY_HAS_BONUS_NEUTRAL_ITEM_CHOICE = 311 -- GetModifierHasBonusNeutralItemChoice
MODIFIER_PROPERTY_HEALTHBAR_PIPS = 286 -- GetModifierHealthBarPips
...
MODIFIER_PROPERTY_HEALTH_BONUS = 96 -- GetModifierHealthBonus
MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT = 93 -- GetModifierConstantHealthRegen
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE = 94 -- GetModifierHealthRegenPercentage
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE_UNIQUE = 95 -- GetModifierHealthRegenPercentageUnique
MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_SOURCE = 51 -- GetModifierHealAmplify_PercentageSource
MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_SOURCE_UNIQUE = 373 -- GetModifierPropertyHealingAmplificationUnique
MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_TARGET = 52 -- GetModifierHealAmplify_PercentageTarget
MODIFIER_PROPERTY_HEROFACET_OVERRIDE = 346 -- GetModifierHeroFacetOverride
MODIFIER_PROPERTY_HP_REGEN_AMPLIFY_PERCENTAGE = 53 -- GetModifierHPRegenAmplify_Percentage
MODIFIER_PROPERTY_HP_REGEN_MULTIPLIER_PRE_AMPLIFICATION = 345 -- GetModifierHPRegenMultiplierPreAmplification
MODIFIER_PROPERTY_IGNORE_ATTACKSPEED_LIMIT = 34 -- GetModifierAttackSpeed_Limit
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 250 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 261 -- GetModifierIgnoreCooldown
MODIFIER_PROPERTY_IGNORE_MOVESPEED_LIMIT = 29 -- GetModifierIgnoreMovespeedLimit
MODIFIER_PROPERTY_IGNORE_PHYSICAL_ARMOR = 82 -- GetModifierIgnorePhysicalArmor
MODIFIER_PROPERTY_ILLUSION_LABEL = 165 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT = 287 -- GetModifierIncomingDamageConstant
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST = 293 -- MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST
MODIFIER_PROPERTY_INCOMING_DAMAGE_ILLUSION = 265
MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE = 63 -- GetModifierIncomingDamage_Percentage
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_CONSTANT = 65 -- GetModifierIncomingPhysicalDamageConstant
MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_PERCENTAGE = 64 -- GetModifierIncomingPhysicalDamage_Percentage
MODIFIER_PROPERTY_INCOMING_SPELL_DAMAGE_CONSTANT = 66 -- GetModifierIncomingSpellDamageConstant
MODIFIER_PROPERTY_INNATE_DAMAGE_BLOCK_PCT_OVERRIDE = 144 -- GetModifierInnateDamageBlockPctOverride
MODIFIER_PROPERTY_INVENTORY_SLOT_RESTRICTED = 353 -- GetModifierInventorySlotRestricted
...
MODIFIER_PROPERTY_IS_ILLUSION = 164 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 239 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 240 -- GetModifierShard
MODIFIER_PROPERTY_ITEM_SELLBACK_COST = 322 -- GetModifierItemSellbackCost
MODIFIER_PROPERTY_KILL_STREAK_BONUS_GOLD_PERCENTAGE = 344 -- GetModifierKillStreakBonusGoldPercentage
MODIFIER_PROPERTY_KNOCKBACK_AMPLIFICATION_PERCENTAGE = 285 -- GetModifierKnockbackAmplification_Percentage
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 54 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 244 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_ARMOR_PIERCING_PERCENTAGE_TARGET = 188 -- GetMagicalArmorPiercingPercentageTarget
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 141 -- GetModifierMagical_ConstantBlock
MODIFIER_PROPERTY_MAGICAL_LIFESTEAL = 363 -- GetModifierProperty_MagicalLifesteal
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BASE_REDUCTION = 83 -- GetModifierMagicalResistanceBaseReduction
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS = 85 -- GetModifierMagicalResistanceBonus
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS_ILLUSIONS = 86 -- GetModifierMagicalResistanceBonusIllusions
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS_UNIQUE = 87 -- GetModifierMagicalResistanceBonusUnique
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE = 88 -- GetModifierMagicalResistanceDecrepifyUnique
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DIRECT_MODIFICATION = 84 -- GetModifierMagicalResistanceDirectModification
MODIFIER_PROPERTY_MANACOST_OVERRIDE = 370 -- GetModifierPropertyManacostOverride
...
MODIFIER_PROPERTY_MANA_BONUS = 97 -- GetModifierManaBonus
MODIFIER_PROPERTY_MANA_DRAIN_AMPLIFY_PERCENTAGE = 59 -- GetModifierManaDrainAmplify_Percentage
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = 90 -- GetModifierConstantManaRegen
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE = 91 -- GetModifierConstantManaRegenUnique
MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE = 92 -- GetModifierTotalPercentageManaRegen
MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 118 -- GetModifierMaxAttackRange
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 183 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_ATTRIBUTE_LEVEL = 349 -- MinAttributeLevel
MODIFIER_PROPERTY_MIN_HEALTH = 159 -- GetMinHealth
MODIFIER_PROPERTY_MIN_MANA = 160 -- GetMinMana
MODIFIER_PROPERTY_MIN_PHYSICAL_ARMOR = 81 -- GetModifierMinPhysicalArmor
MODIFIER_PROPERTY_MISS_PERCENTAGE = 74 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MISS_PERCENTAGE_TARGET = 342 -- GetModifierMiss_Percentage_Target
MODIFIER_PROPERTY_MODEL_CHANGE = 234 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 235 -- GetModifierModelScale
MODIFIER_PROPERTY_MODEL_SCALE_ANIMATE_TIME = 236 -- GetModifierModelScaleAnimateTime
MODIFIER_PROPERTY_MODEL_SCALE_CONSTANT = 238 -- GetModifierModelScaleConstant
MODIFIER_PROPERTY_MODEL_SCALE_USE_IN_OUT_EASE = 237 -- GetModifierModelScaleUseInOutEase
...
MODIFIER_PROPERTY_MOVESPEED_MAX_BONUS_CONSTANT = 367 -- GetModifierMoveSpeedMax_BonusConstant
...
MODIFIER_PROPERTY_MOVESPEED_POST_MULTIPLIER_BONUS_CONSTANT = 368 -- GetModifierMoveSpeedPostMultiplierBonus_Constant 
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 275 -- GetModifierMoveSpeedReductionPercentage
MODIFIER_PROPERTY_MP_REGEN_AMPLIFY_PERCENTAGE = 57 -- GetModifierMPRegenAmplify_Percentage
MODIFIER_PROPERTY_MP_REGEN_AMPLIFY_PERCENTAGE_UNIQUE = 58 -- GetModifierMPRegenAmplify_Percentage_Unique
MODIFIER_PROPERTY_MP_RESTORE_AMPLIFY_PERCENTAGE = 60 -- GetModifierMPRestoreAmplify_Percentage
MODIFIER_PROPERTY_NEGATIVE_EVASION_CONSTANT = 68 -- GetModifierNegativeEvasion_Constant
MODIFIER_PROPERTY_NO_FREE_TP_SCROLL_ON_DEATH = 310 -- GetModifierNoFreeTPScrollOnDeath
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 252 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 253 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 147 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 148 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 11 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 176 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PACK_RAT = 283 -- GetModifierIsPackRat
...
MODIFIER_PROPERTY_PHYSICALDAMAGEOUTGOING_PERCENTAGE = 284 -- GetModifierPhysicalDamageOutgoing_Percentage
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BASE_PERCENTAGE = 75 -- GetModifierPhysicalArmorBase_Percentage
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS = 77 -- GetModifierPhysicalArmorBonus
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_POST = 80 -- GetModifierPhysicalArmorBonusPost
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE = 78 -- GetModifierPhysicalArmorBonusUnique
MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE_ACTIVE = 79 -- GetModifierPhysicalArmorBonusUniqueActive
MODIFIER_PROPERTY_PHYSICAL_ARMOR_PIERCING_PERCENTAGE_TARGET = 187 -- GetPhysicalArmorPiercingPercentageTarget
MODIFIER_PROPERTY_PHYSICAL_ARMOR_TOTAL_PERCENTAGE = 76 -- GetModifierPhysicalArmorTotal_Percentage
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 142 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 143 -- GetModifierPhysical_ConstantBlockSpecial
MODIFIER_PROPERTY_PHYSICAL_LIFESTEAL = 362 -- GetModifierProperty_PhysicalLifesteal
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 139 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_DEADLY_BLOW = 185 -- GetModifierPreAttack_DeadlyBlow
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 140 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PREREDUCE_INCOMING_DAMAGE_MULT = 291 -- GetModifierPrereduceIncomingDamage_Mult
MODIFIER_PROPERTY_PRESERVE_NEUTRAL_ITEM_PASSIVES = 312 -- GetModifierPreserveNeutralItemPassives
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 259 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 12 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 184 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROJECTILE_SPEED = 300 -- GetModifierProjectileSpeed
...
MODIFIER_PROPERTY_PROJECTILE_SPEED_TARGET = 301 -- GetModifierProjectileSpeedTarget
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 245 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_PSEUDORANDOM_BONUS = 339 -- GetModofierPropertyPseudoRandomBonus
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 241 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_REDIRECT_SPELL = 355 -- GetRedirectSpell
MODIFIER_PROPERTY_REFLECT_SPELL = 150 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 122 -- ReincarnateTime
MODIFIER_PROPERTY_REINCARNATION_SUPPRESS_FX = 123 -- ReincarnateSuppressFX
MODIFIER_PROPERTY_REQUIRED_LEVEL = 377 -- GetRequiredLevel
...
MODIFIER_PROPERTY_RESTORATION_AMPLIFICATION = 371 -- GetModifierPropertyRestorationAmplification
MODIFIER_PROPERTY_RESTORATION_AMPLIFICATION_UNIQUE = 372 -- GetModifierPropertyRestorationAmplificationUnique
MODIFIER_PROPERTY_SHARE_XPRUNE = 308 -- GetModifierShareXPRune
MODIFIER_PROPERTY_SKIP_ATTACK_REGULATOR = 341 -- GetSkipAttackRegulator
MODIFIER_PROPERTY_SLOW_RESISTANCE_APPLIES_TO_ATTACKS = 298 -- GetModifierSlowResistanceAppliesToAttacks
MODIFIER_PROPERTY_SLOW_RESISTANCE_STACKING = 297 -- GetModifierSlowResistance_Stacking
MODIFIER_PROPERTY_SLOW_RESISTANCE_UNIQUE = 296 -- GEtModifierSlowResistance_Unique
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 246 -- GetModifierSpellsRequireHP
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE = 48 -- GetModifierSpellAmplify_Percentage
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE_CREEP = 47 -- GetModifierSpellAmplify_PercentageCreep
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE_TARGET = 50 -- GetModifierSpellAmplify_PercentageTarget
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE_UNIQUE = 49 -- GetModifierSpellAmplify_PercentageUnique
MODIFIER_PROPERTY_SPELL_LIFESTEAL_AMPLIFY_PERCENTAGE = 55 -- GetModifierSpellLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_SPELL_LIFESTEAL_AMPLIFY_PERCENTAGE_UNIQUE = 56 -- GetModifierSpellLifestealRegenAmplify_Percentage_Unique
MODIFIER_PROPERTY_SPELL_REDIRECT_TARGET = 281 -- GetModifierSpellRedirectTarget
MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 105 -- GetModifierBonusStats_Agility
MODIFIER_PROPERTY_STATS_AGILITY_BONUS_PERCENTAGE = 108 -- GetModifierBonusStats_Agility_Percentage
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 106 -- GetModifierBonusStats_Intellect
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE = 109 -- GetModifierBonusStats_Intellect_Percentage
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 104 -- GetModifierBonusStats_Strength
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE = 107 -- GetModifierBonusStats_Strength_Percentage
MODIFIER_PROPERTY_STATUS_RESISTANCE = 69 -- GetModifierStatusResistance
MODIFIER_PROPERTY_STATUS_RESISTANCE_CASTER = 71 -- GetModifierStatusResistanceCaster
MODIFIER_PROPERTY_STATUS_RESISTANCE_STACKING = 70 -- GetModifierStatusResistanceStacking
MODIFIER_PROPERTY_STRONG_ILLUSION = 166 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 167 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 168 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_ATTACK_PROCS = 358 -- GetSuppressAttackProcs
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 272 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_CRIT = 319 -- GetSuppressCrit
MODIFIER_PROPERTY_SUPPRESS_FULLSCREEN_DEATH_FX = 292 -- GetModifierSuppressFullscreenDeathFX
MODIFIER_PROPERTY_SUPPRESS_INCOMING_CRIT = 374 -- GetSuppressIncomingCrit
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 270 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 258 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TICK_GOLD_MULTIPLIER = 295 -- GetModifierTickGold_Multiplier
MODIFIER_PROPERTY_TIER_TOKEN_REROLL = 350 -- GetTierTokenReroll
MODIFIER_PROPERTY_TOOLTIP = 233 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 267 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 46 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 146 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_STACKING = 352 -- GetModifierTotal_ConstantBlockStacking
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 145 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 242 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 243 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 182 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_CONSTANT = 282 -- GetModifierTurnRateConstant
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 171 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 170 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 180 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 177 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_UPGRADE_NEUTRAL_ARTIFACTS = 375 -- GetModifierPropertyUpgradeNeutralArtifacts
MODIFIER_PROPERTY_VISION_DEGREES_RESTRICTION = 351 -- GetVisionDegreeRestriction
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 263 -- GetVisualZDelta
MODIFIER_PROPERTY_VISUAL_Z_SPEED_BASE_OVERRIDE = 264 -- GetVisualZSpeedBaseOverride
MODIFIER_PROPERTY_XP_DURING_DEATH = 169 -- GetModifierXPDuringDeath
MODIFIER_PROPERTY_XP_FOUNTAIN_COUNTDOWN_TIME_OVERRIDE = 309 -- GetModifierXPFountainCountdownTimeOverride
...
-- @return void
-- @param nBodyGroup int
-- @param nChoice int
function CBaseModelEntity:SetBodygroup( nBodyGroup, nChoice ) end
